        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card my-3">
                    ...
                    <div class="card-body">
                        <form action="{{route('paymentstore',Auth::user()->id)}}" method="post" class="mt-3">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="integer" class="form-control" name="price" placeholder="price" value="{{$price}}" readonly>
                            </div>
                            <div class="form-group mb-3">
                                <label for="cvc">Card Number</label>
                                <input cvc="text" class="form-control" name="cvc" placeholder="cvc" value="{{old('cvc')}}">
                            </div>
                            <div class="form-group mb-3">
